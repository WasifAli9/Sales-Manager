...
export async function handleLocalObjectPut(req: Request, res: Response): Promise<void> {
  ...
  if (!verifyLocalUpload(objectId, exp, token)) {
  ...
  try {
    ...
    logger.error({ err: error }, 'Local object upload failed');
